...
OBJECTS    = src/gcap/logger.o src/gcap/ip_flow_key.o src/gcap/flow/base_flow.o src/gcap/flow/ip4_tcp_flow.o src/gcap/host_store.o src/gcap/flow_store.o src/gcap/pcap_file_processor.o
